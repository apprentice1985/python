#!/usr/bin/env python
#-*- coding: utf-8 -*-
#Lockinng server with Forking - Chapter 20 - lockingserver.py
...
def writelastaccess(fd, ip):
    """Update file nothing new last access time for the given ip.
    """
    #Accquire an exclusive lock. Nobody else can modify the file
