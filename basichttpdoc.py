#!/usr/bin/env python
#-*- coding: utf-8 -*-
#Basic HTTP Server Example with Two Documents - Chapter 16 - basichttpdoc.py
...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def _writeheaders(self, doc):
        """
        Write the HTTP headers for the document. If there is no document, send a 404 error code;
    ...
    def _getdoc(self, filename):
        ...
        if filename == '/':
            ...
            <a href="status.html">server statistics</a>
            </body></html>
              """
